...
function init() { 
 ...
 function copyElectron() { 
     projectDir.copyAsync('resources/windows/config_example.js', buildDir.path('config.js'));
     projectDir.copyAsync('resources/windows/atv.bin', buildDir.path('atv.bin'));
     return projectDir.copyAsync('./node_modules/electron-prebuilt/dist', buildDir.path(), { overwrite: true }); 
} 
 function copyNodeModules() { 
     return projectDir.copyAsync(appDir.path('node_modules'), buildDir.path('node_modules'), { overwrite: true }); 
} 
...
function updateResources() {
    ...
    projectDir.copy('resources/windows/pdf-pill.jpg', buildDir.path('pdf-pill.jpg'));
    projectDir.copy('resources/windows/pdf-pill-inverse.jpg', buildDir.path('pdf-pill-inverse.jpg'));
