...
Section "Install"
	...
	; restore config an license
	;File /r "tmp\atv.bin"
	;File /r "tmp\config.js"


    ; creating folders

    CreateDirectory "$INSTDIR\Documentos Digitalizados"
    CreateDirectory "$INSTDIR\Documentos Armazenados"
